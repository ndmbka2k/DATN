...
BLYNK_WRITE(V12)
{
  ...
  if(door1==1)  servo1.write(100);
  else          servo1.write(10);
}
BLYNK_WRITE(V13)
{
  boolean door2=param.asInt();
  servo2.attach(PIN_SERVO2);
  if(door2==1)  servo2.write(120);
...
void autowindow()
{
  if(light>90&&tam1==0&&automode==1)
  {
    window(0);
    tam1=1;
  }
  else if(light<90&&tam1==1&&automode==1)
  {
    window(1);
    tam1=0;
  }
...
void autoo()
{
  ...
  lcd1.setCursor(0,0);
  lcd1.print("T: "); lcd1.print(temp1);lcd1.createChar(0,vuong);lcd1.setCursor(5,0);lcd1.write(0);lcd1.print("C ");lcd1.print("H: "); lcd1.print(humi1);lcd1.print(" %  ");
  lcd1.setCursor(0,1);
  lcd1.print("BAO DONG: "); if(warning==0) lcd1.print("OFF"); else lcd1.print("ON  ");
}
void invailid()
{
 ...
 if(swlroom==1)
  {
    ...
    {
    swlroom = map(analogRead(39),0,2900,0,4);
    while(swlroom==1)  swlroom = map(analogRead(39),0,2900,0,4);
    lamp1=!lamp1;
     if(lamp1==1)       
     {
      outmap=onlamp1|outmap;
  ...
  if(swlroom==2)
  {
    ...
    {
    swlroom = map(analogRead(39),0,2900,0,4);
    while(swlroom==2)  swlroom = map(analogRead(39),0,2900,0,4);
    servo1.attach(PIN_SERVO1);
    door1=!door1;
    if(door1==1)  servo1.write(120);
    else          servo1.write(10);
    }
  }
  if(swlroom==3)
  {
    ...
    {
    swlroom = map(analogRead(39),0,2900,0,4);
    while(swlroom==3)  swlroom = map(analogRead(39),0,2900,0,4);
    warning=!warning;
    if(warning==1)       
     {
  ...
  if(swlroom==4)
  {
    ...
    {
    swlroom = map(analogRead(39),0,2900,0,4);
    while(swlroom==4)  swlroom = map(analogRead(39),0,2900,0,4);
    fan1=!fan1;
    if(fan1==1)       
     {
      outmap=onfan1|outmap;
  ...
  if(sw2room==2)
  {
    ...
    {
    sw2room = map(analogRead(34),0,2900,0,4);
    while(sw2room==2)  sw2room = map(analogRead(34),0,2900,0,4);
    lamp4=!lamp4;
     if(lamp4==1)       
     {
      outmap=onlamp4|outmap;
  ...
  if(sw2room==1)
  {
    ...
    {
    sw2room = map(analogRead(34),0,2900,0,4);
    while(sw2room==1)  sw2room = map(analogRead(34),0,2900,0,4);
    fan2=!fan2;
    if(fan2==1)       
     {
      outmap=onfan2|outmap;
  ...
  if(sw2room==3)
  {
    ...
    {
    sw2room = map(analogRead(34),0,2900,0,4);
    while(sw2room==3)  sw2room = map(analogRead(34),0,2900,0,4);
    lamp5=!lamp5;
    if(lamp5==1)       
     {
  ...
  if(sw2room==4)
  {
    ...
    {
    sw2room = map(analogRead(34),0,2900,0,4);
    while(sw2room==4)  sw2room = map(analogRead(34),0,2900,0,4);
    dh=!dh;
    if(dh==1)       
     {
      outmap=ondh|outmap;
